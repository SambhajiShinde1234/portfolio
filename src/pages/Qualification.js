      ...
      <div className="qualification-container">
        <div className="education-section">
          ...
          <div className="education-block">
            ...
            <p className="bottom-gap"> {EducationData[0].institute} </p>
            <p className="bottom-gap">
              <span>
                <CiLocationOn />{" "}
              </span>
              {EducationData[0].place}
            </p>
            <p>
              <span>
                <GoCalendar />{" "}
          ...
          <div className="education-block bcs-block">
            ...
            <p className="bottom-gap">
              ...
              {EducationData[3].place}
            </p>
            <p>
              <span>
                <GoCalendar />{" "}
              </span>
              {EducationData[3].year}
            </p>
          </div>
        </div>
        ...
        <div className="experience-section education-section">
          ...
          <div className="education-block">
            <strong>
              <p className="bottom-gap"> {ExperienceData[0].designation}</p>
            </strong>
